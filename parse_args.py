...
def parse_args():
    ...
    parser.add_argument('--num_img', type=int, default=50, help="Number of images to generate")
    ...
    parser.add_argument('--corpus_mode', type=str, default='chn', choices=['random', 'chn', 'eng', 'list', 'cmnd', 'vbpl', 'plate'],
                        help='Different corpus type have different load/get_sample method'
                             ...
                             'id: pick senetences from ID courpus'
                             'plate: generate random vehicle plate string')
